...
from working_data import starting_account, number_of_accounts, acc_group_name, sale_link


def regirect_to_sale_all():
    for row in range(starting_account, starting_account + number_of_accounts):
        try:
            ...
            client.login()
            client.redirect_to_page(sale_link)
